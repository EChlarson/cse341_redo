...
const mongodb = require('./db/connect'); // Custom module to connect to MongoDB
...
// Connect to MongoDB and then set up routes and start the server
mongodb.initDb((err) => {
  if (err) {
    ...
    // ✅ Now that DB is ready, load your routes
    app.use('/', require('./routes'));
